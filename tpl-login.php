			...
			<div class="shadowblock_out">
				...
				<div class="shadowblock">
					...
					<div class="left-box">
						...
						<form action="<?php echo hmp-theme_get_login_url( 'login_post' ); ?>" method="post" class="loginform" id="login-form">
							...
							<div id="checksave">
								...
								<p class="lostpass">
									<a class="lostpass" href="<?php echo hmp-theme_get_password_recovery_url(); ?>" title="<?php _e( 'Password Lost and Found', APP_TD ); ?>"><?php _e( 'Lost your password?', APP_TD ); ?></a>
								</p>
