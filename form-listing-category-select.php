			...
			<div class="shadowblock_out">
				...
				<div class="shadowblock">
					...
					<div id="step1">
						...
						<form name="mainform" id="mainform" class="form_step" action="<?php echo hmp-theme_get_step_url(); ?>" method="post">
							...
							<ol class="form-fields cat-select">
								...
								<li>
									...
									<div class="ad-static-field"><?php HMP_cost_per_listing(); ?></div>
									<div class="clr"></div>
								</li>
								...
								<li>
									...
									<div id="ad-categories" style="display:block; margin-left:170px;">
										<div id="catlvl0">
											<?php HMP_dropdown_categories_prices(); ?>
									...
									<div id="ad-categories-footer" class="button-container">
										...
										<div id="chosenCategory"><input id="realty_cat_id" name="cat" type="input" value="-1" /></div>
										<div style="clear:both;"></div>
									</div>
									<div style="clear:both;"></div>
								</li>
