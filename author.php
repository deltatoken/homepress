				...
				<div class="shadowblock_out">
					...
					<div class="shadowblock">
						...
						<div class="post">
							...
							<div id="user-photo"><?php hmp-theme_get_profile_pic($curauth->ID, $curauth->user_email, 250); ?></div>

							<div class="author-main">

								<ul class="author-info">
									<li><strong><?php _e( 'Member Since:', APP_TD ); ?></strong> <?php echo hmp-theme_display_date( $curauth->user_registered, 'date', true ); ?></li>
									...
									<?php if ( ! empty( $curauth->facebook_id ) ) { ?><li><div class="dashicons-before facebookico"></div><a href="<?php echo hmp-theme_make_fb_profile_url( $curauth->facebook_id ); ?>" target="_blank"><?php _e( 'Facebook', APP_TD ); ?></a></li><?php } ?>
								</ul>

								<?php HMP_author_info( 'page' ); ?>
