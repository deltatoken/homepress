			...
			<div class="shadowblock_out">
				...
				<div class="shadowblock">
					...
					<div id="step1">
						...
						<form name="mainform" id="mainform" class="form_membership_step" action="<?php echo hmp-theme_get_step_url(); ?>" method="post" enctype="multipart/form-data">
								...
								?>
										...
										<?php
											foreach ( $packages as $package ) {
												...
												$package = apply_filters( 'HMP_package_field', $package, 'membership' );
												if ( ! $package ) {
													continue;
												}
												...
												$rowclass = 'even';
												$requiredClass = '';
												$benefit = HMP_get_membership_package_benefit_text( $package->ID );
										...
										?>
												...
												<tr class="<?php echo $rowclass . ' ' . $requiredClass; ?>">
													...
													<td><?php printf( __( '%1$s / %2$s days', APP_TD ), hmp-theme_get_price( $package->price ), $package->duration ); ?></td>
