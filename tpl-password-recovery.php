			...
			<div class="shadowblock_out">
				...
				<div class="shadowblock">
					...
					<div class="left-box">
						...
						<form action="<?php echo hmp-theme_get_password_recovery_url( 'login_post' ); ?>" method="post" class="loginform password-recovery-form" name="lostpassform" id="lostpasswordform">
