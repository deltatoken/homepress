			...
			<div class="shadowblock_out">
				...
				<div class="shadowblock">
					...
					<div id="step2">
						...
						<form name="mainform" id="mainform" class="form_step steps-review" action="<?php echo hmp-theme_get_step_url(); ?>" method="post" enctype="multipart/form-data">
							...
							<ol>
								...
								<?php
									...
									echo HMP_show_review( $posted_fields );
								?>
							...
							<div class="license"><?php HMP_display_message( 'terms_of_use' ); ?></div>
