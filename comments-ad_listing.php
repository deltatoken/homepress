		...
		<div class="shadowblock">
			...
			<div id="comments">
				...
				<div id="comments_wrap">
					...
					<?php hmp-theme_before_comments(); ?>

					<ol class="commentlist">

						<?php hmp-theme_list_comments(); ?>

					</ol>

					<?php hmp-theme_after_comments(); ?>
					...
					<?php if ( ! empty( $carray['pings'] ) ) : // pings include pingbacks & trackbacks ?>
						...
						<ol class="pinglist">
							...
							<?php hmp-theme_list_pings(); ?>

						</ol>

					<?php endif; ?>

					<?php hmp-theme_after_pings(); ?>

					<?php hmp-theme_before_respond(); ?>

					<?php if ( 'open' == $post->comment_status ) : ?>

						<?php hmp-theme_before_comments_form(); ?>

						<?php hmp-theme_comments_form(); ?>

						<?php hmp-theme_after_comments_form(); ?>

					<?php endif; // open ?>

					<?php hmp-theme_after_respond(); ?>
