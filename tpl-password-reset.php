			...
			<div class="shadowblock_out">
				...
				<div class="shadowblock">
					...
					<div class="left-box reset-password">
						...
						<form action="<?php echo esc_url( hmp-theme_get_password_reset_url( 'login_post' ) ); ?>" method="post" class="loginform password-reset-form" name="resetpassform" id="resetpassform">
