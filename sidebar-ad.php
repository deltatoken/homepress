...
global $current_user, $gmap_active, $HMP_options;

// make sure google maps has a valid address field before showing tab
$gmap_active = false;
$location_fields = get_post_custom();
$_fields = array( 'HMP_zipcode', 'HMP_country', 'HMP_state', 'HMP_street', 'HMP_city' );
...
<div class="content_right">
	...
	<div class="tabprice">
		...
		<div id="priceblock2" class="sidebar-block">
			...
			<?php if ( ( $HMP_options->ad_inquiry_form && is_user_logged_in() ) || ! $HMP_options->ad_inquiry_form ) {
		...
		<div id="priceblock3" class="sidebar-block">
			...
			<div class="postertab">
				...
				<div class="priceblocksmall dotted">
					...
					<div id="userphoto">
						<p class='image-thumb'><?php hmp-theme_get_profile_pic( get_the_author_meta( 'ID' ), get_the_author_meta( 'user_email' ), 140 ); ?></p>
					</div>
					...
					<ul class="member">
						...
						<li><span><?php _e( 'Member Since:', APP_TD ); ?></span> <?php echo hmp-theme_display_date( get_the_author_meta( 'user_registered' ), 'date', true ); ?></li>

					</ul>

					<?php HMP_author_info( 'sidebar-ad' ); ?>
	...
	<?php hmp-theme_before_sidebar_widgets( 'ad' ); ?>
	...
	<?php hmp-theme_after_sidebar_widgets( 'ad' ); ?>
