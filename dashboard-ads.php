<?php if ( $listings = HMP_get_user_dashboard_listings() ) : ?>
	...
	<table style="border:0;" cellpadding="4" cellspacing="1" class="tblwide footable">
		...
		<?php while ( $listings->have_posts() ) : $listings->the_post(); $i++; ?>
			...
			<?php hmp-theme_load_template( 'content-dashboard-' . get_post_type() . '.php', array( 'i' => $i ) ); ?>
	...
	<?php hmp-theme_pagination( '', '', $listings ); ?>
