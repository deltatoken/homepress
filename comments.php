		...
		<div class="shadowblock">
			...
			<div id="comments">
				...
				<div id="comments_wrap">
					...
					<?php hmp-theme_before_blog_comments(); ?>

					<ol class="commentlist">

						<?php hmp-theme_list_blog_comments(); ?>

					</ol>

					<?php hmp-theme_after_blog_comments(); ?>
					...
					<?php hmp-theme_before_blog_pings(); ?>
					...
					<?php if ( ! empty( $carray['pings'] ) ) : // pings include pingbacks & trackbacks ?>
						...
						<ol class="pinglist">
							...
							<?php hmp-theme_list_blog_pings(); ?>

						</ol>

					<?php endif; ?>

					<?php hmp-theme_after_blog_pings(); ?>

					<?php hmp-theme_before_blog_respond(); ?>

					<?php if ( 'open' == $post->comment_status ) : ?>

						<?php hmp-theme_before_blog_comments_form(); ?>

						<?php hmp-theme_blog_comments_form(); ?>

						<?php hmp-theme_after_blog_comments_form(); ?>

					<?php endif; // open ?>

					<?php hmp-theme_after_blog_respond(); ?>
