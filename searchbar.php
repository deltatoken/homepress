...
if ( is_page_template( 'tpl-ads-home.php' ) || is_search() || is_404() || is_tax( APP_TAX_CAT ) || is_tax( APP_TAX_TAG ) || is_singular( APP_POST_TYPE ) ) :
	...
	$args = HMP_get_dropdown_categories_search_args( 'bar' );
?>
			...
			<div class="searchblock">
				...
				<form action="<?php echo home_url( '/' ); ?>" method="get" id="searchform" class="form_search">
					...
					<div class="searchfield">
						...
						<input name="s" type="text" id="s" tabindex="1" class="editbox_search" style="<?php HMP_display_style( 'search_field_width' ); ?>" value="<?php the_search_query(); ?>" placeholder="<?php esc_attr_e( 'What are you looking for?', APP_TD ); ?>" />
